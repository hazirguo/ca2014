...
Compute the effective CPI for MIPS using [Figure A.27](../../figureA.27.png) and the table
...
a. Invent your own assembly language mnemonics ([Figure A.2](../../figureA.2.png)
